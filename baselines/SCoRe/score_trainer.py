        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            with torch.no_grad():
                ...
                for i in range(0, queries.shape[0], args.local_rollout_forward_batch_size):
                    ...
                    del query, query_response, response, logprob, ref_logprob
                    torch.cuda.empty_cache()

                first_logprobs = torch.cat(first_logprobs, dim=0)
                ...
                first_kl = first_logprobs - first_ref_logprobs
            ...
            for ppo_epoch_idx in range(args.num_ppo_epochs):
                ...
                for mini_batch_start in range(0, args.local_batch_size, args.local_mini_batch_size):
                    ...
                    del (
                        ...
                        mb_advantage, mb_responses, mb_query_responses, mb_logprobs, logitss,
                    )
                    # fmt: on
                    torch.cuda.empty_cache()
            ...
            with torch.no_grad():
                ...
                mean_first_non_score_reward = first_non_score_reward.mean()
                eps = int(self.state.episode / (time.time() - start_time))
                first_mean_kl = first_kl.sum(1).mean()
                metrics = {}
                metrics["eps"] = eps
