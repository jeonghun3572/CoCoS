...
from cocos.prompts import code_process, make_fewshot, make_prompt
from cocos.rewards import get_reward_one_reward
            ...
            with torch.no_grad():
                ...
                with unwrap_model_for_generation(
                    ...
                    for i in range(0, batch_size, args.local_rollout_forward_batch_size):
                        ...
                        responses = self.processing_class.batch_decode(
                ...
                responses_for_prompt = [
                    [code_process(r.strip()).strip()] for r in responses_for_prompt
                ]
